...
<html lang="en">
  <head>
    <title>{{ config('app.name') }} - Find your next job on tech or hire a Developer without stress</title>
    <meta charset="utf-8">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="#recentjobs" class="nav-link">Recent jobs</a></li>
            <li class="nav-item"><a href="/about" class="nav-link">About</a></li>
            <li class="nav-item"><a href="" class="nav-link">Blog</a></li>
	          <li class="nav-item"><a href="" class="nav-link">Contact</a></li>
	          <li class="nav-item cta mr-md-2"><a href="{{ route('companies.register') }}" class="nav-link">Post a Job</a></li>
	          <li class="nav-item cta cta-colored"><a href="{{ route('register') }}" class="nav-link">Want a Job?</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-xl-10 ftco-animate mb-5 pb-5" data-scrollax=" properties: { translateY: '70%' }">
          	<p class="mb-4 mt-5 pt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">We have <span class="number" data-number="{{ DevRocks\Models\Job::where('is_open', true)->count() }}">0</span> great job offers you deserve!</p>
			              ...
			              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
			              	<form action="#" class="search-job">
			              		<div class="row">
                                    ...
                                    <?php foreach (DevRocks\Models\Category::select('id', 'category')->get() as $category): ?>
    ...
    <section class="ftco-section ftco-counter">
        ...
        <div class="row">
        	<div class="col-md-3 ftco-animate">
        		<ul class="category">
              <?php foreach (DevRocks\Models\Category::select('id', 'category')->get() as $category): ?>
                <li><a href="/categories/{{ $category->id }}">{{ $category->category }} <span class="number" data-number="1000">0</span></a></li>
              <?php endforeach; ?>
